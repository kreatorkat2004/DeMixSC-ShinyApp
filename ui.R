                        ...
                        tabsetPanel(
                          tabPanel("Retina",
                                   tags$div(
                                     sidebarLayout(
                                       sidebarPanel(
                                         selectInput("retinaDataset", "Select Dataset:", choices = c("AMD Cohort", "Benchmark")),
                                         actionButton("runRetina", "Run Analysis", class = "btn-primary")
                                       ),
                                       mainPanel(
                                         plotlyOutput("retinaPlot"),
                                         DTOutput("retinaResults")
                                       )
                                     )
                                   )
                          ),
                          tabPanel("HGSC",
                                   tags$div(
                                     sidebarLayout(
                                       sidebarPanel(
                                         selectInput("hgscDataset", "Select Dataset:", choices = c("Lee Cohort", "Benchmark")),
                                         actionButton("runHGSC", "Run Analysis", class = "btn-primary")
                                       ),
                                       mainPanel(
                                         plotlyOutput("hgscPlot"),
                                         DTOutput("hgscResults")
                                       )
                                     )
                                   )
                          )
